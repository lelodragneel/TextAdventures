...
public class City{
	public static void main (String [] args){
		System.out.println("The trees thin out as your path grows wider and wider. Rough dirt is replaced by slabs of well-worn stone.");
		crossroads();			
	}
	public static void crossroads(){
		...
		System.out.println("To your LEFT, a narrower street winds off through a collection of smaller buildings. Lights can be seen in the distance.");
		System.out.println("To your RIGHT, a short fence separates the path from a scruffy-looking field. You could jump over it, if you wanted to.");
		...
		while(roomNum==0){
			if(direction.equals("f"))
				...
				System.out.println("Command not recognized. Type f for forward, l for left, or r for right.");
				direction=keyboard.nextLine();
			}
		}
		choosePath(roomNum);
	...
	public static void room2(){
		...
		//User is forced to battle a monster. If they die, they must return to the crossroads.
		monsterBattle("trash creature");
		System.out.println("You sit down on a bit of rubble to recover. Wait... what's that over there?");
		...
		if(direction.equals("y")){
			...
			//User battles a monster. If they die, they must return to the crossroads.
			...
			//User acquires shield item. If they are a warrior, their stats rise accordingly and set item to "true". 
			//Check whether the boss has been defeated. If so, congratulatory message. End level.
			//If not, the user must now choose a different path to walk.
			System.out.println("There doesn't seem to be anything more to explore down this path.\nYou make your way back to the crossroads.");
			choosePath(0);
		}
	...
	public static void room3(){
		...
		System.out.println("You hear a creak, and see a door starting to open.You have just enough time to retreat, if you choose to.");
		System.out.println("Will you retreat? Or will you move forward? Type r or f.");
		direction=keyboard.nextLine();
		...
		if(direction.equals("r")){
			System.out.println("You RETREAT to the shadows and wait until whoever it is goes back inside.");
			System.out.println("Unfortunately, you're not alone.");
			//User battles a monster
			monsterBattle("shadow creature");
			System.out.println("He can’t have roamed very far… scouting ahead may lead you to his source.");
			System.out.println("Type s to scout ahead, or c to return to the CROSSROADS.");
			direction=keyboard.nextLine();
		...
		if(direction.equals("f")){
			...
			System.out.println("Will you face the monster? Or will you return to the CROSSROADS? Type f or c.");
			direction=keyboard.nextLine();
	...
	public static void bossRoom(){
		...
		//Check whether the item has also been found if boss is defeated. If so, congratulatory message. End level.
		//If not, just update bossDefeated to true and return to the crossroads.
		crossroads();
	}
	public static void room5(){
		...
		System.out.println("Finally, you manage to escape back to the crossroads.");
		crossroads();
	}
	public static void monsterBattle(String name){
		...
		//If the user dies, display message and send them back to the crossroads.
	}
