...
public class Woods {
	...
	public int pathFinder(String p) {
		...
		String[] paths = { "lrlllrl", "rlrlrllrr", "llr", "lllr", "llll",
				"lrrl", "lrrrl", "lrrrr", "lrlr", "lrllr", "lrllll",
				"lrlllrrl", "lrlllrrr", "rrrr", "rrl", "rrrl", "rll", "rlrr",
				"rlrll", "rlrlrr", "rlrlrlr", "rlrlrlll", "rlrlrllrl" };
		// "end" array is for determining what has been found, "paths" and "end"
		// correspond. 0 = spellbook 1 = main monster 2 = dead-end 3 = random
		// bonus(?) 4 = mini-monster
		int[] end = { 0, 1, 2, 2, 3, 2, 2, 3, 2, 2, 2, 2, 3, 2, 3, 4, 2, 2, 4,
				3, 2, 2, 4 };
		...
		while (lost) {
			...
			if (start == true) {
				...
				if (temp.equals("y")) {
					...
					if (temp.equals("l")) {
						System.out
								.println("The monster you seek is anything but right, but he left destruction with a key."
			...
			// While you're not at the start...
				...
				System.out
						.println("Choose which path to take now! Type l/r to choose or b to go back to last crossroad:");
				temp = sc.nextLine();
				...
				// Choosing a path.
					...
					if (pathFinder(path) == 0) {
						System.out
								.println("You find a sad old man sitting on the tree stump. He is holding a rusty old book in his hands. He turns to look at you as you approach him and asks:"
										+ "\n\"Are you here to take my book? Enter y/n.\"");
						temp = sc.nextLine();
						// Choosing no.
						if (temp.equals("n"))
							System.out
									.println("The wizard looks at you angrily and waves a wooden wand at you."
											+ "\n\"Then back to the start you go!\"");
						// Choosing yes.
						if (temp.equals("y")) {
							int chances = 3;
							System.out
									.println("The wizards looks at you up and down. Then combs his beard while looking at his book."
							...
							while (chances != 0) {
								System.out
										.println("(Type a path using r and l, you have "
												+ chances + " chances!)");
								// Correct answer.
								if (temp.equals("lrlllrl")) {
									System.out
											.println("The wizard smiles happily at you and hands you his spellbook."
								...
								// When incorrect.
									...
									System.out
											.println("The wizards shakes his head somberly.");
									chances--;
									if (chances == 0)
										System.out
												.println("The wizards stands up angrily and waves a wooden wand at you.");
								}
							}
						}
						path = "";
					...
					// The monster goal of the forest to leave the forest.
						...
						lost = false;
						System.out
								.println("Congratulations, you escaped the woods!");
					}
					// Deadends.
